      ...
      <script type="text/javascript">
        ...
        function child_fields(cm) {
          ...
          html.push(
            ...
            '<div class="col-md-3 nopadding"><div class="form-group">',
            '<input type="text" class="form-control" id="pw-child-dob' + child + '" name="pw-child-dob[]" value="' + child_dob[child] ? child_dob[child] : "" + '" placeholder="DOB"></div></div>',
            '<div class="col-md-3 nopadding"><div class="form-group">',
            '<input type="text" class="form-control" id="pw-child-cn" name="pw-child-cn[]" value="' + child_cn[child] ? child_cn[child] : "" + '" placeholder="CLIENT NUMBER"></div></div>',
            '<div class="col-md-3 nopadding"><div class="form-group">',
